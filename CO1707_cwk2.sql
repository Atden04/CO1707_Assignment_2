...
(3, 'Graduation promo', 'Graduating this year? then you are entitled to 25% your total shop. Just add items to your cart and use the discount code GRAD2024 to receive the discount');
...
(1, 'Matthew Bates', 'C&T Building, University of Central Lancashire, Preston.', 'mbates5@uclan.ac.uk', '$2y$10$2Ww0EECu2EbCNAJPxeIycO2nEzZANDI3RdhA6Tb8NZHdfQpgNZCnW', '2024-01-01 00:01:00');
COMMIT;
